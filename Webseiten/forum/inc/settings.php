...
$settings['mail_parameters'] = "server@suchtgaming.de";
$settings['adminemail'] = "server@suchtgaming.de";
...
$settings['boardclosed_reason'] = "Das Forum ist zurzeit in Wartungsarbeiten!";
$settings['bbname'] = "SuchtGaming.de Forum";
$settings['bburl'] = "https://suchtgaming.de/forum";
...
$settings['bblanguage'] = "deutsch_sie";
...
$settings['homename'] = "SuchtGaming.de";
$settings['homeurl'] = "https://suchtgaming.de";
...
$settings['captchaprivatekey'] = "6Lc-Tr0UAAAAAC7Q77iEISqmyf5kmRX7U5sQk-od";
$settings['captchapublickey'] = "6Lc-Tr0UAAAAAKYb77WsHhEvMjPgDXu87t0ABu1Q";
...
$settings['returnemail'] = "server@suchtgaming.de";
...
$settings['smtp_host'] = "cmail01.mc-host24.de";
$settings['smtp_pass'] = "suchtgamingserveradmins";
$settings['smtp_port'] = "25";
$settings['smtp_user'] = "server@suchtgaming.de";
